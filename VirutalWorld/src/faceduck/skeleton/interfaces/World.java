...
public interface World {
	...
	/**
	 * Returns true if loc is able to move in any direction, false otherwise.
	 *
	 * @param loc
	 *            the location to inspect
	 *
	 ...
	 *             If loc is null.
	 *
	 * @return true if loc is able to move in the world, false otherwise.
	 */
//	public boolean abletoMove(Location loc);
}
